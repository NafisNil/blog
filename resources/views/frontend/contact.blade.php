        ...
        <div class="row form-map">
            <div class="col-lg-6 col-md-12">
                ...
                <form action="{{ route('contact_send_email') }}" method="post">
                    ...
                    <div class="mb-3">
                        <textarea class="form-control" placeholder="Message (Required)" rows="3" name="comment" required></textarea>
                    </div>
                    <div class="mb-3">
