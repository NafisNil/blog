...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('dist_frontend') }}/css/all.css">
    <link rel="stylesheet" href="{{ asset('dist_frontend') }}/css/owl.carousel.min.css">
    ...
    <div class="home-banner">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="right">
                        <img src="{{ asset('dist_frontend') }}/images/man.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="left wow fadeInLeft">
                        <img src="{{ asset('dist_frontend') }}/images/man2.jpg" alt="">
                    </div>
                </div>
                <div class="col-md-8">
                    ...
                    <div class="owl-carousel owl-theme testimonial-carousel">
                        <div class="item">
                            <div class="photo d-flex justify-content-center">
                                <img src="{{ asset('dist_frontend') }}/images/t1.jpg" alt="">
                            </div>
                            <div class="comment">
                        ...
                        <div class="item">
                            <div class="photo d-flex justify-content-center">
                                <img src="{{ asset('dist_frontend') }}/images/t2.jpg" alt="">
                            </div>
                            <div class="comment">
                        ...
                        <div class="item">
                            <div class="photo d-flex justify-content-center">
                                <img src="{{ asset('dist_frontend') }}/images/t3.jpg" alt="">
                            </div>
                            <div class="comment">
