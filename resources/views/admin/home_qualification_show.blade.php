...
@section('title')
    Dashboard - Edit Home Qualification 
@endsection
                    ...
                    <form action="{{ route('admin_home_qualification_update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="mb-4">
                                    <label class="form-label">Qualification Sub Title </label>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="qualification_status" id="" class="form-control">
                                        <option value="1" @if ($page_data->qualification_status == '1')
                                            selected
                                        @endif>Show</option>
                                        <option value="0" @if ($page_data->qualification_status == '0')
                                            selected
                                        @endif>Hide</option>
                                    </select>
                                </div>
