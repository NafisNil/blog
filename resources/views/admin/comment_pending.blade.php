...
@section('title')
    Dashboard - View Pending Comments
@endsection
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="example1">
                            ...
                            <tbody>
                                @foreach ($pending_comment as $item)
                            <tr>
                                ...
                                <td class="pt_10 pb_10">
                                    <a href="{{ route('admin_comment_make_approve', $item->id) }}" class="btn btn-info btn-sm" >Make Approve</a>
