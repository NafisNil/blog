                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="skill_status" id="" class="form-control">
                                        <option value="1" @if ($page_data->skill_status == '1')
                                            selected
                                        @endif>Show</option>
                                        <option value="0" @if ($page_data->skill_status == '0')
                                            selected
                                        @endif>Hide</option>
                                    </select>
                                </div>
