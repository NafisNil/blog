                    ...
                    <form action="{{ route('admin_profile_submit') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <input type="file" class="form-control mt_10" name="bsnner_photo">
                            </div>
                            <div class="col-md-9">
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="banner_description" id="" cols="30" rows="10" class="form-control h-100">{{ $page_data->banner_description }}</textarea>
                                </div>
                                <div class="mb-4">
